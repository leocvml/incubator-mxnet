...
this example attemps to reproduce [DSOD: Learning Deeply Supervised Object Detectors from Scratch](https://arxiv.org/abs/1708.01241) use gluon reimplementation 
...
## DataSet ##
this example is training on **pikachu dataset**  

## Usage ##
#### training ####
**python train.py --epoch 50**  (initial weights initialized as random )  
**python train.py --epoch 50 --retrain 1** ( load last time weights and continue training)  
**python train.py --help gives the following arguments:**
```
optional arguments:
  -h, --help         show this help message and exit
  --batch BATCH      number of batch
  --size SIZE        resolution of image
  --epoch EPOCH      number of epochs
  --retrain RETRAIN  load weighting and continue training
  --dataset DATASET  name of .rec and .lst
  --params PARAMS    name of params
  --gpu GPU          use GPU or not


```
#### inference  ####
**python inference.py --image pikachu.jpg --score 0.7**  (image name and thresholding)  
**python inference.py --help gives the following arguments:**
```
optional arguments:
  -h, --help       show this help message and exit
  --params PARAMS  name of params
  --size SIZE      resolution of image
  --gpu GPU        use GPU or not
  --image IMAGE    inference image
  --score SCORE    displayed when box score greater than this threshold
...
![](MD_IMG/DSOD_ARCH.png)![](MD_IMG/backbone_fisrthalf.PNG)
```python
####################################################
###
...
with net.name_scope():
    net.add(
        DSOD(32, 6, 32, 1, 1)   # 64 6 48 1 1 in paper
    )
...
python train.py --epoch 1 --dataset **name of your dataset**
...
## learn more .. ##
you can also see these  tutorial  
